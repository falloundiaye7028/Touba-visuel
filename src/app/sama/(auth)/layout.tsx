...
import { APP_NAME, APP_SLOGAN } from "@/lib/sama/constants";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10 bg-gradient-to-b from-vert-900 via-vert-800 to-vert-700">
      <Link href="/sama" className="mb-6 text-center">
        <div className="text-2xl font-extrabold text-white tracking-tight">{APP_NAME}</div>
      ...
      <p className="text-vert-100/80 text-xs mt-6">© {new Date().getFullYear()} {APP_NAME} · Sénégal</p>
    </div>
  );
}
