  ...
  return (
        <main
              ...
              <div className="max-w-7xl mx-auto">
                      ...
                      <div className="grid lg:grid-cols-5 gap-8 items-start">
                        ...
                        {/* ── PANNEAU CONTRÔLES ─────────────── */}
                                <div className="lg:col-span-2 space-y-4">
                                  ...
                                  {/* Nom entreprise */}
                                            <div className="rounded-2xl p-5 border border-white/6" style={{ background: "#0d0d1a" }}>
                                                          ...
                                                          <input
                                                                            ...
                                                                            className="w-full rounded-xl px-4 py-3 text-sm border focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                                                            style={INPUT_STYLE}
                                                                          />
                                            </div>div>
                                  ...
                                  {/* Description */}
                                            <div className="rounded-2xl p-5 border border-white/6" style={{ background: "#0d0d1a" }}>
                                                          ...
                                                          <textarea
                                                                            ...
                                                                            rows={4}
                                                                            className="w-full rounded-xl px-4 py-3 text-sm border focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
                                                                            style={INPUT_STYLE}
                                                                          />
                                                          <p className="text-right text-xs text-gray-500 mt-1">{description.length} car.</p>p>
                                            </div>div>
                                  ...
                                  <button
                                                        ...
                                                        className={`px-3 py-2.5 rounded-xl text-sm font-medium transition-all text-left flex items-center gap-2 border ${
                                                                                styleId === s.id
                                  ...
                                  {/* CTA */}
                                            <button
                                                            ...
                                                            style={{
                                                                              ...
                                                                              color: "#fff",
                                                                              boxShadow: loading || !description.trim() ? "none" : "0 0 30px rgba(99,102,241,0.4)",
                                                            }}
                                                          >
                        ...
                        {/* ── PANNEAU RÉSULTAT ──────────────── */}
                                  <div className="lg:col-span-3">
                                              <div
                                                              className="rounded-3xl border border-white/8 overflow-hidden flex items-center justify-center"
                                                              style={{ background: "#0a0a14", minHeight: "400px", ...aspectStyle }}
                                                            >
                                                {loading && (
                                                                              <div className="text-center p-8">
                                                                                                <div className="w-16 h-16 border-4 border-indigo-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
                                                                                                <p className="text-gray-400 text-sm">Génération en cours…</p>p>
                                                                                                <p className="text-gray-600 text-xs mt-1">Cela peut prendre 10–30 secondes</p>p>
                                                                              </div>div>
                                                            )}
                                                ...
                                                {!loading && hasError && (
                                                                              <div className="text-center p-8">
                                                                                                ...
                                                                                                <p className="text-red-400 font-semibold mb-1">Génération échouée</p>p>
                                                                                                <p className="text-gray-500 text-sm mb-4">{errMsg || "Essayez une description plus simple ou relancez."}</p>p>
                                                                                                <button
                                                                                                                      onClick={() => generer()}
                                                                              ...
                                                                              <div className="relative w-full h-full">
                                                                                ...
                                                                                {/* Actions */}
                                                                                                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                                                                                                                    <button
                                                                                                                                            onClick={telecharger}
                                                                                                                                            className="px-4 py-2 rounded-xl text-xs font-bold text-white backdrop-blur-sm flex items-center gap-2"
                                                                                                                    ...
                                                                                                                    <button
                                                                                                                                            onClick={() => generer()}
                                                                                                                                            className="px-4 py-2 rounded-xl text-xs font-bold text-white backdrop-blur-sm flex items-center gap-2"
                                                                                                                                            style={{ background: "rgba(99,102,241,0.6)", border: "1px solid rgba(99,102,241,0.5)" }}
                                                                                                                                          >
                                                                                                                                          ↻ Regénérer
                                                                                                                      </button>button>
                                                                                                  </div>div>
                                                                                {seed > 0 && (
                                                                                                    <div className="absolute top-3 right-3 px-2 py-1 rounded-lg text-xs text-gray-400 backdrop-blur-sm"
                                                ...
                                                {!loading && !hasError && !imgSrc && (
                                                                              <div className="text-center p-8">
                                                                                                <div className="text-6xl mb-4 opacity-20">🖼️</div>div>
                                                                                                <p className="text-gray-500 text-sm">Votre visuel apparaîtra ici</p>p>
                                                                                                <p className="text-gray-600 text-xs mt-1">Décrivez votre image et cliquez sur Générer</p>p>
                                                                              </div>div>
                                                            )}
                                              </div>div>
                                  </div>div>
                ...
                {/* ── TEMPLATES ─────────────────────── */}
                      <div className="mt-16">
                                <h2 className="text-white text-2xl font-black mb-2">Templates prêts à l&apos;emploi</h2>h2>
                                <p className="text-gray-500 text-sm mb-8">Cliquez sur un template pour l&apos;appliquer, puis générez.</p>p>
                      
                        {categories.map((cat) => (
                            <div key={cat} className="mb-8">
                                          <h3 className="text-indigo-300 text-sm font-bold uppercase tracking-widest mb-3">{cat}</h3>h3>
                                          <div className="flex flex-wrap gap-2">
                                            {TEMPLATES.filter((t) => t.categorie === cat).map((t) => (
                                                <button
                                                                    ...
                                                                    >
                                                                    <span className="font-semibold">{t.label}</span>span>
                                                                    <span className="block text-xs text-gray-500 mt-0.5 max-w-[200px] truncate">{t.prompt.substring(0, 60)}…</span>span>
                                                </button>button>
                                              ))}
                                          </div>div>
                            </div>div>
                ...
                {/* ── FORMATS INFO ──────────────────── */}
                      <div className="mt-12 grid md:grid-cols-3 gap-4">
                        {[
                { icon: "📸", title: "Post Instagram", desc: "Format carré 1024×1024 optimisé pour Instagram et Facebook." },
                { icon: "📱", title: "Stories & Reels", desc: "Format vertical 9:16 prêt pour Stories Instagram, TikTok, Snapchat." },
                { icon: "🖨️", title: "À imprimer", desc: "Visuels HD — parfaits pour flyers, affiches, kakémonos et t-shirts." },
                          ].map((item) => (
                                        <div key={item.title} className="rounded-2xl p-5 border border-white/6 text-center" style={{ background: "#0d0d1a" }}>
                                                      <div className="text-3xl mb-2">{item.icon}</div>div>
                                                      <h3 className="text-white font-bold mb-1">{item.title}</h3>h3>
                                                      <p className="text-gray-400 text-sm">{item.desc}</p>p>
                                        </div>div>
                                      ))}
                      </div>div>
              
                {/* ── CTA PACK ──────────────────────── */}
                      <div className="mt-12 rounded-3xl p-8 text-center border border-indigo-500/20"
                                  style={{ background: "linear-gradient(135deg, rgba(99,102,241,0.1), rgba(168,85,247,0.1))" }}>
                                <p className="text-indigo-300 text-sm font-bold uppercase tracking-widest mb-2">Passer au niveau supérieur</p>p>
                                <h2 className="text-white text-3xl font-black mb-3">30 visuels pro par mois, automatiquement ?</h2>h2>
                                <p className="text-gray-400 max-w-2xl mx-auto mb-6">
                                            Avec nos packs Marketing IA, notre équipe génère et publie vos visuels automatiquement — vous ne faites que valider.
                                </p>p>
                                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                            ...
                                            <a href="https://wa.me/221768001717?text=Je veux un pack IA pour des visuels automatiques"
                                                            ...
                                                            className="px-6 py-3 rounded-xl font-bold transition-all border border-white/20 text-white hover:bg-white/5">
