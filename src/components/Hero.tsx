    ...
    <section className="relative gradient-animated min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-24 pb-32 w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-up delay-400">
          <Link href="/catalogue"
            className="group inline-flex items-center justify-center gap-3 bg-white text-vert-950 font-bold px-9 py-4 rounded-2xl hover:bg-vert-50 transition-all duration-300 shadow-2xl text-base hover:shadow-white/20 hover:scale-[1.02]">
            Voir le catalogue
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-4">
            {/* Card DONNEZ UNE AUTRE DIMENSION */}
        ...
        {/* Signature */}
        <div className="text-center mt-14 animate-fade-in delay-500">
