...
async function main() {
  ...
  await prisma.organization.upsert({ where: { slug: "intelligenceimmobilier-demo-dakar" }, update: {}, create: { id: organizationId, name: "INTELLIGENCE IMMOBILIER Démo Dakar", slug: "intelligenceimmobilier-demo-dakar", phone: "+221 33 800 00 00", email: "demo@intelligenceimmobilier.com", address: "Dakar, Sénégal", country: "SN", currency: "XOF", subscriptionPlan: "AGENCY", subscriptionStatus: "ACTIVE" } });
