...
export default function DashboardPage() {
  return <div className="page-content">
    <div className="page-heading"><div><p className="eyebrow">DIMANCHE 30 AOÛT 2026</p><h1>Bonjour Mamadou<span>.</span></h1><p>Voici ce qui se passe aujourd’hui chez IMMOTERA Demo Dakar.</p></div><div className="heading-actions"><button className="button secondary"><CalendarDays size={16}/>Ce mois-ci</button><Link className="button primary" href="/payments?new=1">+ Nouveau paiement</Link></div></div>
